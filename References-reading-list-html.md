...
We (Zhiqiang, Lynne, Beata and Ben) originally compiled these resources whilst writing the ADR-Scotland course Introduction to Data Science for Administrative Data Research (formerly Working with Administrative Data) in 2017. The practical side of the course focused on data manipulation, visualization and the potential pitfalls specific to analysing routinely collected data in the social sciences. We have since run the course again and have updated the list below with additional materials we discussed with participants on the edition of the course.

You can see the course website at http://adrc-s-intro-to-data-linkage-course.weebly.com/.

What follows is a pretty exhaustive list (we don’t expect course participants to read everything on here!), so a good place to start are the course texts. We ran the course using R (https://www.r-project.org/). However we have run the course using both Stata and R previously so we list some references here for both programs.
...
* For an introduction to the new pivot_wider and pivot_longer functions in {tidyr} 1.0.0 see Simpson 2019 Pivoting tidily - https://www.fromthebottomoftheheap.net/2019/10/25/pivoting-tidily/
...
o Introduction - https://www.youtube.com/watch?v=DyGonV7A_EY
o Record linkage process - https://www.youtube.com/watch?v=dcNTvYDdun0
o Advanced record linkage techniques - https://www.youtube.com/watch?v=HAKW5tHVCmw
o Privacy aspects in record linkage - https://www.youtube.com/watch?v=4Iv5axrAWqQ
